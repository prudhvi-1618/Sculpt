            ...
            {links.map((link,index)=>{
                return (
                   <div className='my-2 w-[50vw]'>
                     <div  key={index} className=' bg-slate-100  rounded-md px-5 py-2 flex justify-between  font-sans text-zinc-900' >

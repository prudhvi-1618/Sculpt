...
const Footer = () => {
  return (
    <>
    <div className='w-full h-screen px-20 md:flex gap-3 pt-[9vw] '>
    ...
    <div className="footer w-full md:flex justify-between items-center px-20 pb-2">
     <div className="logo pb-2 w-36">
        <img src={logo} alt=""  />
       </div>
